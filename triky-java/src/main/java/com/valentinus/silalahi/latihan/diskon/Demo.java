...
public class Demo {
	public static void main(String[] xxx) {
		...
		pd2.setPembelian(pb);
		System.out.println("Total belanja : " + pb.hitungTotalPembelian());
		// simpan pb ke database

		// lihat konfigurasi diskon di database
		PerhitunganDiskonTotalPajakPpn discTax = new PerhitunganDiskonTotalPajakPpn();
		...
		System.out.println("Total harus dibayar : " + pb.hitungTotalHarusDibayar());
